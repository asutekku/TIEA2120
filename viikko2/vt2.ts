...
class Controller {
    ...
    static newRasti(e) {
        ...
        let form: HTMLFormElement = document.getElementById("form_lisaaRasti");
    ...
    static saveJoukkue(e) {
        if (e.preventDefault) e.preventDefault();
        let form: HTMLFormElement = document.getElementById("form_lisaaJoukkue");
        let formData = new FormData(form);
        ...
        if (!create.editMode) {
            ...
            if (!Controller.formEmpty(form)) {
                ...
                document.getElementById("tulosTable").appendChild(create.teamRow(joukkue));
                form.reset();
            }
        } else {
            let team = util.getJoukkueet(data)[this.teamIndex];
            console.log("ay");
        }
    }
    ...
    static validateJoukkueForm() {
        ...
        document.getElementById("joukkueButton").disabled = false;
    }
    ...
    static editJoukkue(jj) {
        if (!create.editMode) {
            ...
            for (let jasen of team.jasenet) {
                document.getElementById("input_1_" + jasenCount).value = jasen.toString();
                jasenCount++;
            }
            document.getElementById("input_1_0").value = team.nimi;
        } else {
...
class create {
    ...
    static form(type: string, title: string,) {
        ...
        if (type === "rasti") {
            ...
            let jasenMaara = 2;
            document.getElementById("jasenButton").onclick = function () {
                jasenMaara++;
    ...
    static table(arr) {
        ...
        for (let joukkue of joukkueet) {
            ...
            document.getElementById("a_" + joukkue.nimi).addEventListener('onclick', Controller.editJoukkue, false);
        }
    }
